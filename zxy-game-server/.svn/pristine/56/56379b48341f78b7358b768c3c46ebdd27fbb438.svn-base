 ...
 */
@Component
public class UseParser14 extends UseParser {

	@Override
	protected UseGoodsParserType getParserType() {
		return UseGoodsParserType.TYPE14;
	}
	...
	public TResult<List<UseGoodsResult>> handler(long actorId, int goodsId, int useNum, int useFlag) {
		...
		boolean result2 = actorFacade.addEnergy(actorId, EnergyAddType.USE_GOODS,actor.maxEnergy);
