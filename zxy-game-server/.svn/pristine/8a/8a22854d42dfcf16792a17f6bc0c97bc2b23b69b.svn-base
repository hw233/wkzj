 ...
 */
@AppVO
public class RecordInfoVO17 implements BaseRecordInfoVO {
	/**
	 * 
	 */
	...
	public BaseRecordInfoVO valueOf(String record) {
		...
		RecordInfoVO17 recordInfoVO17 = new RecordInfoVO17();
		if(items != null){
			items = StringUtils.fillStringArray(items, 2, "0");
			recordInfoVO17.rewardTime = Integer.valueOf(items[0]);
			recordInfoVO17.isGet = Integer.valueOf(items[1]);
		}
		return recordInfoVO17;
	}
