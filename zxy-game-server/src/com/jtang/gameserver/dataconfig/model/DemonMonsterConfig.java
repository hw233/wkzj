 ...
 *
 */
@DataFile(fileName = "demonMonsterConfig")
public class DemonMonsterConfig implements ModelAdapter {
	...
	public void initialize() {
		...
		for (String item : list) {
			...
			int gridIndex = Integer.valueOf(attrs.get(0));
			int monsterId = Integer.valueOf(attrs.get(1));
