 ...
 */
@Component
public class Parser1100 extends AbstractInBattleEffectParser {
	@Override
	public boolean castSkill(Fighter caster, Fighter target, TargetReport report, InbattleEffectConfig effect, Context context) {
		...
		return addHurtComputedByOneArg(caster, target, report, atk, effect, context);
	}

	@Override
	protected int getParserId() {
		return InbattleParserKey.Parser1100;
	}
}
